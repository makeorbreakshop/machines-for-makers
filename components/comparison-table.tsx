            ...
            <table className="w-full border-collapse">
              <thead className="sticky top-0 z-10">
                <tr className="bg-muted/50">
                  {/* Fixed machine column */}
                  <th className="sticky left-0 z-20 bg-muted/50 p-2 px-3 text-left font-medium text-sm whitespace-nowrap border-b border-r min-w-[200px]">
                    Machine
                  </th>
                  ...
                  {allVisibleColumns.map((column) => (
                    <th
                      key={column.id}
                      className="bg-muted/50 p-2 px-3 text-left font-medium text-sm whitespace-nowrap border-b min-w-[120px]"
                    >
                      {column.name}
                    </th>
                  ))}
                  ...
                  {/* Compare column */}
                  <th className="bg-muted/50 p-2 px-3 text-center font-medium text-sm whitespace-nowrap border-b min-w-[80px]">
                    Compare
                  </th>
                </tr>
              </thead>
              <tbody>
                {machines.map((machine, index) => {
                  ...
                  <tr key={machine.id} className={`hover:bg-muted/10 ${index % 2 === 0 ? "bg-white" : "bg-muted/5"}`}>
                    {/* Fixed machine column */}
                    <td className="sticky left-0 z-10 bg-inherit border-r p-2 px-3">
