                ...
                return (
                  <th
                    ...
                    className={`p-2 px-3 text-left font-medium text-sm whitespace-nowrap ${
                      isFirstColumn 
                        ? "sticky left-0 z-30 bg-white min-w-[220px] w-[220px] shadow-[2px_0px_5px_0px_rgba(0,0,0,0.05)]" 
                        : "min-w-[120px] w-[140px]"
                    }`}
                  >
                  ...
                  return (
                    <td
                      ...
                      className={`p-2 px-3 text-sm ${
                        isFirstColumn 
                          ? `sticky left-0 z-20 ${rowIndex % 2 === 0 ? "bg-white" : "bg-gray-50"} shadow-[2px_0px_5px_0px_rgba(0,0,0,0.05)]` 
